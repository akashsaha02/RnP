...
const JobItem=({type,employee_salary,position,date})=>{
    return(
        <>
        <div className="bg-white mt-10 rounded-lg flex justify-between">
        <p className="font-semibold p-1 pl-3">{type}</p>
        <svg
      ...
      <div className="bg-white mt-10 h-60 w-80 p-5">
        ...
        <p className="text-gray-400 text-sm mt-1 pl-3">CTC: ${employee_salary}</p>
